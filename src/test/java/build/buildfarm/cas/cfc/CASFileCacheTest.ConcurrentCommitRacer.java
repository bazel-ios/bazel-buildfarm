...
class CASFileCacheTest {
  ...
  Path buildFetchableDir(Digest fileDigest, String fileName, String subdirName, Map<Digest, Directory> outDirectoriesIndex) throws IOException, InterruptedException {
...
*/
		      ...
		      /*
                     if (!Files.exists(barPath)) {
                      ...
                      ListenableFuture<Digest> barDirDigest = buildFetchableDirDigest(barDigest, "bar.ref", "bar.dir");
                      System.out.println("Make blobDigest: " + blobDigest);
                      //buildFetchableDir:161 bytes
                      ListenableFuture<Digest> blobDirDigest = buildFetchableDirDigest(blobDigest, blobName + "blob.ref", blobName + "dir");
